const questionsVariees = [
  {
    question: "Quel plat traditionnel toulousain est fait à base de viande de canard, de saucisse de Toulouse et de haricots blancs ?",
  ...
  {
    question: "Quel célèbre peintre impressionniste français a réalisé des tableaux de Toulouse, notamment du Pont Neuf ?",
  ...
  {
    question: "Quel grand événement aéronautique se tient tous les deux ans à Toulouse, mettant en avant l'industrie aérospatiale ?",
  ...
  {
    question: "Quelle pièce de théâtre comique écrite par Molière se déroule en partie à Toulouse et met en scène un personnage avare ?",
  ...
  {
    question: "Quel est le nom du célèbre festival musical qui se déroule chaque été dans la ville de Toulouse et attire des artistes internationaux ?",
  ...
  {
    question: "Quel monument emblématique de Toulouse est surnommé 'Le Bazacle' et est un ancien moulin à eau sur la Garonne ?",
  ...
  {
    question: "Quelle équipe de rugby toulousaine est l'une des plus titrées en France et en Europe ?",
  ...
  {
    question: "Quelle rue de Toulouse est célèbre pour ses boutiques de joaillerie et de luxe, en faisant une destination de shopping prisée ?",
  ...
  {
    question: "Quel célèbre événement a lieu chaque année en avril à Toulouse et met en avant la culture japonaise, y compris la cuisine, la musique et l'art ?",
  ...
  {
    question: "Quelle équipe de football toulousaine a évolué en Ligue 1 et a souvent été surnommée 'Le Téfécé' ?",
  ...
  {
    question: "Quel célèbre écrivain français, auteur de 'Voyage au bout de la nuit', est né à Toulouse en 1894 ?",
  ...
  {
    question: "Quelle fête traditionnelle toulousaine se déroule chaque année en septembre et met en avant la gastronomie locale ?",
  ...
  {
    question: "Quel est le nom de cette viénoiserie ?",
    choices: ["Une chocolatine", "Une chocolatine", "Une chocolatine", "Une chocolatine"],
    correctAnswer: "Une chocolatine",
    fact: "Une chocolatine",
    imgQ: "./images/Quiz/Photo3.png"
  },
  {
    question: "Quelle célèbre compagnie aéronautique européenne a son siège social à Toulouse et est connue pour la fabrication d'avions civils ?",
  ...
  {
    question: "Quel célèbre écrivain français du 19e siècle a écrit le roman 'Les Trois Mousquetaires', dont une partie se déroule à Toulouse ?",
  ...
  {
    question: "Quel événement sportif annuel à Toulouse attire des passionnés de cyclisme du monde entier et propose un parcours montagneux ?",
  ...
  {
    question: "Quel célèbre compositeur français du 18e siècle, connu pour ses opéras et sa musique symphonique, est né à Toulouse ?",
  ...
  {
    question: "Quelle rivière traverse la ville de Toulouse avant de se jeter dans la Méditerranée ?",
  ...
  {
    question: "Quel célèbre écrivain français, considéré comme le fondateur du roman de science-fiction, est né à Toulouse en 1828 ?",
  ...
  {
    question: "Quel célèbre peintre français, connu pour ses œuvres impressionnistes, a passé du temps à Toulouse et a peint des scènes de la ville ?",
  ...
  {
    question: "Quelle université prestigieuse de Toulouse a été fondée en 1229 et est l'une des plus anciennes universités d'Europe ?",
  ...
  {
    question: "Quelle célèbre actrice française, connue pour ses rôles dans des films comme 'Amélie Poulain', est originaire de Toulouse ?",
  ...
  {
    question: "Quel célèbre explorateur français du 16e siècle est né à Toulouse et est connu pour avoir exploré le Mississippi aux États-Unis ?",
  ...
  {
    question: "Quelle ancienne place publique au cœur de Toulouse est entourée de bâtiments historiques et est un lieu animé pour les marchés et les festivals ?",
